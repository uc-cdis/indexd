...
def test_data(app_client, user, combined_default_and_single_table_settings):
    _, client = app_client
...
def test_query_urls(app_client, test_data, combined_default_and_single_table_settings):
    """
    Args:
        client (test fixture)
...
def test_query_urls_metadata(
    app_client, test_data, combined_default_and_single_table_settings
):
    """
    Args:
        client (test fixture)
