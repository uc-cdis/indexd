...
class Record(Base):
    ...
    acl = Column(ARRAY(String), index=True)
    authz = Column(ARRAY(String), index=True)
    urls = Column(ARRAY(String), index=True)
    record_metadata = Column(JSONB, index=True)
    url_metadata = Column(JSONB, index=True)
    alias = Column(ARRAY(String), index=True)
