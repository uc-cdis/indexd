...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("size", sa.BIGINT(), index=True),
        sa.Column("created_date", sa.DateTime, nullable=True),
        sa.Column("updated_date", sa.DateTime, nullable=True),
        sa.Column("file_name", sa.VARCHAR(), index=True),
        sa.Column("version", sa.VARCHAR(), index=True),
        sa.Column("uploader", sa.VARCHAR(), index=True),
