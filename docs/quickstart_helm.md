...
Deploying indexd this way will use the defaults that are defined in this [values.yaml file](https://github.com/uc-cdis/gen3-helm/blob/master/helm/indexd/values.yaml)

You can learn more about these values by accessing the indexd [README.md](https://github.com/uc-cdis/gen3-helm/blob/master/helm/indexd/README.md)
...
```bash
helm upgrade --install gen3/indexd -f values.yaml
```
