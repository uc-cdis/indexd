...
The purpose of this [Azure DevOps Pipeline](../azure-devops-pipeline.yaml) is to build `Indexd`, run a test suite, and then push the `indexd` container into an [Azure Container Registry](https://docs.microsoft.com/en-us/azure/container-registry/container-registry-get-started-portal).
